...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    filteredLeaderboard: function filteredLeaderboard() {
      ...
      return this.leaderboard.filter(function (u) {
        return (u.name || '').toLowerCase().includes(s) || (u.unique_code || '').toLowerCase().includes(s);
      });
    }
  },
  ...
  methods: {
    ...
    loadData: function loadData() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _yield$Promise$all, _yield$Promise$all2, raffleRes, lbRes, lbMap, sorted;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return Promise.all([_this3.$http.get('/api/winners/raffle'), _this3.$http.get('/api/winners')]);
            case 3:
              _yield$Promise$all = _context2.sent;
              _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 2);
              raffleRes = _yield$Promise$all2[0];
              lbRes = _yield$Promise$all2[1];
              _this3.leaderboard = lbRes.data.data || [];
              lbMap = {};
              _this3.leaderboard.forEach(function (u) {
                lbMap[u.unique_code] = u.total_points;
              });
              sorted = (raffleRes.data.data.carousel || []).sort(function (a, b) {
                var diff = (lbMap[b.unique_code] || 0) - (lbMap[a.unique_code] || 0);
              ...
              _this3.carousel = sorted;
              _this3.byMatch = raffleRes.data.data.by_match || [];
              _this3.selectedMatchIdx = 0;
              if (_this3.activeIdx >= _this3.carousel.length) _this3.activeIdx = 0;
              _context2.next = 20;
              break;
            case 18:
              _context2.prev = 18;
    ...
    _c("div", { staticClass: "winners-body" }, [
                      ...
                      [
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _vm.carousel[_vm.activeIdx].total_points
      ...
      _c(
        ...
        [
                          ...
                          [
                            ...
                            _c("div", { staticClass: "wl-right" }, [
                              _c("span", { staticClass: "wl-pts" }, [
                                _vm._v(_vm._s(w.total_points) + " pts"),
                              ]),
                            ]),
                          ]
                        )
          ...
          _c(
            "div",
            { staticClass: "winner-ad-carousel" },
            [
              _c("transition", { attrs: { name: "ad-fade", mode: "out-in" } }, [
                _c("img", {
                  key: _vm.adIndex,
                  staticClass: "winner-ad-carousel-img",
                  attrs: {
                    src:
                      _vm.$imgBase +
