...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapGetters)(['currentUser'])), {}, {
    selectedRaffleGroup: function selectedRaffleGroup() {
    ...
    displayMatches: function displayMatches() {
      var dateKey = function dateKey(m) {
        return m.match_date_bd || m.match_date;
      };
      var nextDate = this.upcomingMatches.length ? dateKey(this.upcomingMatches[0]) : null;
      var upcoming = nextDate ? this.upcomingMatches.filter(function (m) {
        return dateKey(m) === nextDate;
      }) : [];
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return Promise.all([_this.fetchMatches(), _this.fetchMyPoints(), _this.fetchRaffleWinners()]);
          case 2:
            _this.loading = false;
  ...
  methods: {
    ...
    fetchMatches: function fetchMatches() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _yield$Promise$all, _yield$Promise$all2, live, upcoming, sm;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return Promise.all([_this2.$http.get('/api/matches/live'), _this2.$http.get('/api/matches?status=upcoming'), _this2.$http.get('/api/livescores/today')]);
            case 2:
              _yield$Promise$all = _context2.sent;
              _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 3);
              live = _yield$Promise$all2[0];
              upcoming = _yield$Promise$all2[1];
              sm = _yield$Promise$all2[2];
              _this2.liveMatches = live.data.data;
              _this2.upcomingMatches = upcoming.data.data;
              _this2.smMatches = sm.data.data || [];
            case 10:
            case "end":
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _this3.$http.get('/api/winners/my-points');
            case 2:
              _yield$_this3$$http$g = _context3.sent;
              data = _yield$_this3$$http$g.data;
              _this3.myPoints = data.data.total_points;
            case 5:
            case "end":
    ...
    fetchRaffleWinners: function fetchRaffleWinners() {
      var _this4 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return _this4.$http.get('/api/winners/raffle');
            case 2:
              _yield$_this4$$http$g = _context4.sent;
              data = _yield$_this4$$http$g.data;
              _this4.raffleByMatch = (data.data.by_match || []).filter(function (rm) {
                return rm.match_id !== null;
              });
              _this4.selectedRaffleIdx = 0;
            case 6:
            case "end":
    ...
    smKey: function smKey(name) {
      var aliases = {
        ...
        'bosnia herzegov': 'bosnia',
        'bosnia hrz': 'bosnia'
      };
      var n = name.toLowerCase().replace(/[üúûùçñéèêáàâóôöïíî]/g, function (c) {
        return {
          'ü': 'u',
          'ú': 'u',
          'û': 'u',
    ...
    smTime: function smTime(match) {
      var _this6 = this;
      var t1 = this.smKey(match.team1 && match.team1.name || '');
      var t2 = this.smKey(match.team2 && match.team2.name || '');
      var found = this.smMatches.find(function (s) {
        return _this6.smKey(s.home) === t1 && _this6.smKey(s.away) === t2;
      });
      return found ? found.kickoff_bd : null;
    },
    smMinute: function smMinute(match) {
      var _this7 = this;
      var t1 = this.smKey(match.team1 && match.team1.name || '');
      var t2 = this.smKey(match.team2 && match.team2.name || '');
      var found = this.smMatches.find(function (s) {
        return _this7.smKey(s.home) === t1 && _this7.smKey(s.away) === t2;
      });
    ...
    _c("div", { staticClass: "ls-card" }, [
                          ...
                          [
                            _c("div", { staticClass: "mc-date-bold" }, [
                              _vm._v(
                                _vm._s(
                                  _vm.formatMatchDate(
                                    match.match_date_bd || match.match_date
                                  )
                                )
                              ),
                            ]),
                            ...
                            _c("div", { staticClass: "mc-body" }, [
                              ...
                              _c("div", { staticClass: "score-col" }, [
                                ...
                                _c("div", { staticClass: "mc-time" }, [
                                  ...
                                  match.match_time_bd || _vm.smTime(match)
                                    ? _c("span", { staticClass: "bd-label" }, [
                                        _vm._v("BD"),
                                      ])
                                    : _vm._e(),
                                ]),
                                ...
                                match.status === "live"
                                  ...
                                  : _vm._e(),
                                _vm._v(" "),
                                match.status === "live" && _vm.smMinute(match)
                                  ? _c("span", { staticClass: "live-minute" }, [
                                      _vm._v(_vm._s(_vm.smMinute(match)) + "'"),
                                    ])
                                  : _vm._e(),
                                _vm._v(" "),
      ...
      _c("div", { staticClass: "ls-sidebar" }, [
        ...
        _c("div", { staticClass: "top10-card" }, [
          ...
          _vm._v(" "),
          _vm.raffleByMatch.length > 0
            ? _c(
                "div",
                { staticClass: "match-tabs" },
                _vm._l(_vm.raffleByMatch, function (rm, i) {
                  return _c(
                    "button",
                    {
                      key: i,
                      staticClass: "match-tab",
                      class: { active: _vm.selectedRaffleIdx === i },
                      on: {
                        click: function ($event) {
                          _vm.selectedRaffleIdx = i
                        },
                      },
                    },
                    [
          ...
          _c(
            ...
            [
              _vm.selectedRaffleGroup &&
              _vm.selectedRaffleGroup.winners.length > 0
                ? _vm._l(_vm.selectedRaffleGroup.winners, function (w, i) {
                ...
                : _c("div", { staticClass: "state-msg" }, [
                    _vm._v("Raffle draw winners appear here."),
                  ]),
            ],
            2
          ),
