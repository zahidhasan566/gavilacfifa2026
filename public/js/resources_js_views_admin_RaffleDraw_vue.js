...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _this2.matches = (data.data || data).map(function (m) {
                var _m$team, _m$team2;
                return {
                  id: m.id,
                  label: "".concat(((_m$team = m.team1) === null || _m$team === void 0 ? void 0 : _m$team.name) || '?', " vs ").concat(((_m$team2 = m.team2) === null || _m$team2 === void 0 ? void 0 : _m$team2.name) || '?', " (").concat(m.match_date || '', ")")
                };
              });
            case 5:
            case "end":
    ...
    onMatchChange: function onMatchChange() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              params = {
                min_points: _this3.minPoints
              };
              if (_this3.selectedMatchId) params.match_id = _this3.selectedMatchId;
              _context2.next = 4;
              return _this3.$http.get('/api/admin/raffle/eligible', {
                params: params
              });
            case 4:
              _yield$_this3$$http$g = _context2.sent;
              data = _yield$_this3$$http$g.data;
              _this3.eligible = data.data;
            case 7:
            case "end":
    ...
    fetchHistory: function fetchHistory() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var params, _yield$_this4$$http$g, data;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              params = {};
              if (_this4.selectedMatchId) params.match_id = _this4.selectedMatchId;
              _context3.next = 4;
              return _this4.$http.get('/api/admin/raffle/history', {
                params: params
              });
            case 4:
              _yield$_this4$$http$g = _context3.sent;
              data = _yield$_this4$$http$g.data;
              _this4.history = data.data;
            case 7:
            case "end":
    ...
    fetchWinnerCount: function fetchWinnerCount() {
      var _this5 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var params, _yield$_this5$$http$g, data;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              params = {};
              if (_this5.selectedMatchId) params.match_id = _this5.selectedMatchId;
              _context4.next = 4;
              return _this5.$http.get('/api/admin/raffle/winner-count', {
                params: params
              });
            case 4:
              _yield$_this5$$http$g = _context4.sent;
              data = _yield$_this5$$http$g.data;
              _this5.winnerCount = data.data.count;
            case 7:
            case "end":
    ...
    randomDraw: function randomDraw() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        var payload, _yield$_this6$$http$p, data, _e$response, _e$response$data;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              payload = {
                min_points: _this6.minPoints
              };
              if (_this6.selectedMatchId) payload.match_id = _this6.selectedMatchId;
              _context5.next = 5;
              return _this6.$http.post('/api/admin/raffle/random', payload);
            case 5:
              _yield$_this6$$http$p = _context5.sent;
              data = _yield$_this6$$http$p.data;
              _this6.randomWinner = data.data;
              _context5.next = 13;
              break;
            case 10:
              _context5.prev = 10;
              _context5.t0 = _context5["catch"](0);
              _this6.$toaster.error(((_e$response = _context5.t0.response) === null || _e$response === void 0 ? void 0 : (_e$response$data = _e$response.data) === null || _e$response$data === void 0 ? void 0 : _e$response$data.message) || 'No eligible users.');
            case 13:
            case "end":
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _this7.selectedUserId = _this7.randomWinner.id;
              _this7.randomWinner = null;
            case 2:
            case "end":
      ...
      _c("div", { staticClass: "raffle-left" }, [
        _c("div", { staticClass: "card-header" }, [
          ...
          _c("div", { staticClass: "filter-row-inline" }, [
            _c("label", { staticClass: "filter-label" }, [_vm._v("Match:")]),
            _vm._v(" "),
            _c(
              "select",
              {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.selectedMatchId,
                    expression: "selectedMatchId",
                  },
                ],
                staticClass: "mini-select",
                on: {
                  change: [
                    function ($event) {
                      ...
                      _vm.selectedMatchId = $event.target.multiple
                        ? $$selectedVal
                        : $$selectedVal[0]
                    },
                    _vm.onMatchChange,
            ...
            _c("input", {
              ...
              on: {
                input: function ($event) {
                  ...
                  _vm.maxWinners = _vm._n($event.target.value)
                },
                blur: function ($event) {
                  return _vm.$forceUpdate()
                },
          ...
          _c(
            "div",
            {
              staticClass: "winner-count-badge",
              class: { full: _vm.winnerCount >= _vm.maxWinners },
            },
            [
              _vm._v(
                "\n                    " +
                  _vm._s(_vm.winnerCount) +
                  " / " +
                  _vm._s(_vm.maxWinners) +
                  " winners\n                "
              ),
            ]
          ),
          ...
          _c(
            "button",
            {
              staticClass: "btn-random",
              attrs: { disabled: _vm.winnerCount >= _vm.maxWinners },
              on: { click: _vm.randomDraw },
            },
            [_vm._v("🎲 Random Draw")]
          ),
        ]),
        ...
        _vm.selectedUserId
          ? _c(
              "div",
              { staticClass: "confirm-draw" },
              [
                _vm.winnerCount >= _vm.maxWinners
                  ? _c("div", { staticClass: "max-reached-msg" }, [
                      _vm._v(
                        "\n                    Maximum winners (" +
                          _vm._s(_vm.maxWinners) +
                          ") reached for this match.\n                "
                      ),
                    ])
                  : [
