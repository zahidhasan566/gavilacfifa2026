...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var _yield$Promise$all, _yield$Promise$all2, matches, sm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return Promise.all([_this3.$http.get('/api/matches'), _this3.$http.get('/api/livescores/today')]);
          case 2:
            _yield$Promise$all = _context.sent;
            _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 2);
            matches = _yield$Promise$all2[0];
            sm = _yield$Promise$all2[1];
            _this3.matches = matches.data.data;
            _this3.smMatches = sm.data.data || [];
  ...
  methods: {
    ...
    smTime: function smTime(match) {
      ...
      var found = this.smMatches.find(function (s) {
        return _this4.smKey(s.home) === t1 && _this4.smKey(s.away) === t2;
      });
                    ...
                    _c("span", { staticClass: "db-time" }, [
                      _vm._v(
                        _vm._s(
                          m.match_time_bd ||
                            _vm.smTime(m) ||
                            _vm.formatTime(m.match_time)
                        )
                      ),
                      m.match_time_bd || _vm.smTime(m)
                        ? _c("span", { staticClass: "bd-tag" }, [_vm._v("BD")])
                        : _vm._e(),
                    ]),
                  ]),
                ]),
